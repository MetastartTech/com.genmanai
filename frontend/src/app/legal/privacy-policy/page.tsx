  ...
  return (
    <div className="min-h-screen overflow-y-scroll overflow-x-hidden scrollbar scrollbar-none font-opensans">
      <div className="p-4 max-w-screen-lg mx-auto mb-4">
        ...
        <p className="my-2">Last updated: {new Date().toDateString()}</p>
        <p className="my-2">
        ...
        <ul className="list-disc pl-8 my-2">
          ...
          <li>
            <p className="my-2">
              ...
              in this Agreement) refers to GenmanAI
            </p>
          </li>
          <li>
            <p className="my-2">
          ...
          <li>
            <p className="my-2">
              <strong>Website</strong> refers to Genman, accessible from{" "}
              <a
                href="https://www.genmanai.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.genmanai.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul className="list-disc pl-8 my-2">
          <li>By email: hi@genmanai.com</li>
        </ul>
      </div>
    </div>
  );
