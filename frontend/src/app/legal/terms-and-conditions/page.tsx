  ...
  return (
    <div className="min-h-screen overflow-y-scroll overflow-x-hidden scrollbar scrollbar-none font-opensans">
      <div className="p-4 max-w-screen-lg mx-auto mb-4">
        ...
        <p className="my-2">Welcome to GenMan!</p>

        <p className="my-2">
          These terms and conditions outline the rules and regulations for the
          use of GenMan&apos;s Website, located at https://www.genmanai.com/.
        </p>

        <p className="my-2">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use GenMan if you do not agree to take
        ...
        <p className="my-2">
          We employ the use of cookies. By accessing GenMan, you agreed to use
          cookies in agreement with the GenMan&apos;s Privacy Policy.
        </p>
        ...
        <p className="my-2">
          Unless otherwise stated, GenMan and/or its licensors own the
          intellectual property rights for all material on GenMan. All
          intellectual property rights are reserved. You may access this from
          GenMan for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p className="my-2">You must not:</p>
        <ul className="list-disc pl-8 my-2">
          <li>Republish material from GenMan</li>
          <li>Sell, rent or sub-license material from GenMan</li>
          <li>Reproduce, duplicate or copy material from GenMan</li>
          <li>Redistribute content from GenMan</li>
        </ul>

        <p className="my-2">This Agreement shall begin on the date hereof.</p>

        <p className="my-2">
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          GenMan does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of GenMan,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, GenMan shall not be liable
        ...
        <p className="my-2">
          GenMan reserves the right to monitor all Comments and to remove any
        ...
        <p className="my-2">
          You hereby grant GenMan a non-exclusive license to use, reproduce,
        ...
        <p className="my-2">
          ...
          the hyperlink compensates the absence of GenMan; and (d) the link is
        ...
        <p className="my-2">
          ...
          sending an e-mail to GenMan. Please include your name, your
        ...
        <p className="my-2">
          No use of GenMan&apos;s logo or other artwork will be allowed for
