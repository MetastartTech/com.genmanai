...
const LLMRequests = () => {
  ...
  return (
    <div
      className={`space-y-4 py-2 md:py-4 md:col-span-3 md:border-l h-full md:h-[calc(100vh-65px)]`}
    >
      {sidebarLoading ? (
        <SidebarLoader />
      ) : (
        <div className="md:px-3 py-2 flex flex-col h-full overflow-y-auto">
